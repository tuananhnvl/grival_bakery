...
const SvgVintage = () => (
    ...
    <g xmlns="http://www.w3.org/2000/svg" id="Layer_1-2" data-name="Layer 1" className='cls-slogan'>
        <line id="rightt" className="cls-2" y1="25.17" x2="63.45" y2="25.17"/>
        <line id="bott" className="cls-2" x1="75.09" y1="50" x2="75.09" y2="36.39"/>
        <path id="star" className="cls-1" d="m69.9,25.17l4.15-1,1.04-3.98,1.04,3.98,4.15,1-4.15,1-1.04,3.98-1.04-3.98-4.15-1Z"/>
        <line id="bott-2" data-name="bott" className="cls-2" x1="75.09" y1="13.61" x2="75.09"/>
    </g>
