  ...
  return () => clearTimeout(timer);
    ...
    return (
        <div className="maxWidth" id="combo">
            <Slogan top={0} left={-72}  position={'relative'} margin={'0 auto'} width={'fit-content'} height={'fit-content'}/>
                                    ...
                                    {Array.isArray(value.value) ? (value.value).map((data, index) => {
                                        ...
                                        return (
                                            <TRCombo key={data.idc}>
                                                ...
                                                <TDCombo width={'14%'}><p><strong>{new Intl.NumberFormat('vi-VN', { style: 'currency', currency: 'VND' }).format(Number(data.price))}</strong></p></TDCombo>
                                                <TDCombo width={'34%'}>
                                                  <div>
